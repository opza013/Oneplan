...
async function handler(req, res) {
  ...
  if (url.pathname === "/api/health" && req.method === "GET") {
    return sendJson(res, 200, {
      ...
      version: "5.4.0-enterprise-interface",
  ...
  if (url.pathname === "/api/version" && req.method === "GET") {
    return sendJson(res, 200, { version: "5.4.0-enterprise-interface" });
  }
...
server.listen(PORT, "0.0.0.0", () => {
  console.log(`OnePlan v5.4.0-enterprise-interface running on 0.0.0.0:${PORT}`);
